...
const tenseData = [
  { tense: "Simple Present", formula: "S + V(s/es)", signals: "always, usually, every day", example: "She writes reports daily." },
  { tense: "Present Continuous", formula: "S + am/is/are + V-ing", signals: "now, currently, at the moment", example: "The graph is showing a rise." },
  { tense: "Present Perfect", formula: "S + have/has + V³", signals: "since, for, already, yet, just", example: "Prices have increased since 2010." },
  { tense: "Present Perfect Cont.", formula: "S + have/has been + V-ing", signals: "for, since, how long", example: "She has been studying for 3 hours." },
  { tense: "Simple Past", formula: "S + V² / V-ed", signals: "yesterday, last year, ago, in 2005", example: "The population rose sharply in 1990." },
  { tense: "Past Continuous", formula: "S + was/were + V-ing", signals: "while, when, at that time", example: "They were discussing the issue." },
  { tense: "Past Perfect", formula: "S + had + V³", signals: "before, after, already, by the time", example: "She had finished before he arrived." },
  { tense: "Simple Future", formula: "S + will/shall + V¹", signals: "tomorrow, next year, soon", example: "The trend will continue next decade." },
  { tense: "Future Continuous", formula: "S + will be + V-ing", signals: "at this time tomorrow, next week", example: "They will be working on it tomorrow." },
  { tense: "Future Perfect", formula: "S + will have + V³", signals: "by + future time", example: "By 2030, it will have risen further." },
];

const svaRules = [
  { title: "Basic Singular Rule", bangla: "একক বিষয় → একক verb", formula: "She/He/It + V(s/es)", correct: "She writes well. / The student attends class.", wrong: "She write well. / The student attend class." },
  { title: "Plural Subject", bangla: "বহুবচন বিষয় → বহুবচন verb", formula: "They/Students + V (no -s)", correct: "They write reports. / Students study hard.", wrong: "They writes reports. / Students studies hard." },
  { title: "Collective Nouns", bangla: "দলবাচক বিশেষ্য → সাধারণত একক", formula: "team / group / committee + is / was", correct: "The team is ready. / The committee has decided.", wrong: "The team are ready. (informal only)" },
  { title: "There is / There are", bangla: "There-এর পরের noun দেখে verb ঠিক করুন", formula: "There is + singular | There are + plural", correct: "There is a problem. / There are many issues.", wrong: "There is many issues. / There are a problem." },
  { title: "Intervening Phrase", bangla: "মাঝের phrase উপেক্ষা করুন", formula: "S + [of the / with the...] + V (match to S)", correct: "The quality of the reports is poor. / One of the students is absent.", wrong: "The quality of the reports are poor. / One of the students are absent." },
  { title: "Either...or / Neither...nor", bangla: "কাছের subject অনুযায়ী verb", formula: "Neither X nor Y + V (match Y)", correct: "Neither the teacher nor the students are ready.", wrong: "Neither the students nor the teacher are ready." },
  { title: "Indefinite Pronouns", bangla: "everyone, each, no one → সবসময় একক", formula: "everyone / each / nobody + is / has / does", correct: "Everyone has a role. / Each student is responsible.", wrong: "Everyone have a role. / Each students are responsible." },
  { title: "Uncountable Nouns", bangla: "information, advice, news → সবসময় একক", formula: "Uncountable noun + is / was (never are/were)", correct: "The information is useful. / His advice was helpful.", wrong: "The information are useful. / His advice were helpful." },
];

const voiceData = [
  { tense: "Simple Present", active: "write(s)", passive: "am/is/are + written" },
  { tense: "Simple Past", active: "wrote", passive: "was/were + written" },
  { tense: "Present Perfect", active: "have/has written", passive: "have/has been + written" },
  { tense: "Simple Future", active: "will write", passive: "will be + written" },
  { tense: "Modal", active: "can/must write", passive: "can/must be + written" },
];

const articlesData = [
  { article: "a", use: "First mention of a singular countable noun", example: "She wrote a report.", bangla: "প্রথমবার উল্লেখ" },
  { article: "an", use: "Before a vowel sound (not vowel letter)", example: "an hour / an MBA / a university", bangla: "স্বরধ্বনির আগে" },
  { article: "the", use: "Specific / unique / previously mentioned noun", example: "The report was published in 2020.", bangla: "নির্দিষ্ট বস্তু" },
  { article: "Ø (zero)", use: "Plural general, uncountable general, proper nouns", example: "Water is essential. / Countries trade goods.", bangla: "সাধারণ অর্থে" },
];

const conditionalsData = [
  { type: "Zero", ifClause: "If + Simple Present", mainClause: "Simple Present", meaning: "Always true facts", example: "If water boils, it evaporates." },
  { type: "1st (Real)", ifClause: "If + Simple Present", mainClause: "will + V¹", meaning: "Likely future", example: "If you study, you will pass." },
  { type: "2nd (Unreal)", ifClause: "If + Simple Past", mainClause: "would + V¹", meaning: "Imaginary present/future", example: "If I were rich, I would travel." },
  { type: "3rd (Past unreal)", ifClause: "If + Past Perfect", mainClause: "would have + V³", meaning: "Impossible past", example: "If she had studied, she would have passed." },
  { type: "Mixed", ifClause: "If + Past Perfect", mainClause: "would + V¹", meaning: "Past cause, present result", example: "If I had slept, I wouldn't be tired now." },
];

const modalsData = [
  { modal: "must", bangla: "বাধ্যবাধকতা / নিশ্চিত অনুমান", strength: "100%", example: "Governments must invest in education." },
  { modal: "should", bangla: "পরামর্শ / প্রত্যাশা", strength: "90%", example: "Students should manage their time." },
  { modal: "will", bangla: "ভবিষ্যৎ / ইচ্ছা", strength: "90%", example: "This will have a positive impact." },
  { modal: "can", bangla: "সক্ষমতা / সম্ভাবনা", strength: "70%", example: "Technology can solve many problems." },
  { modal: "could", bangla: "অতীত সক্ষমতা / ভদ্র অনুরোধ", strength: "50%", example: "This could have a negative impact." },
  { modal: "would", bangla: "শর্তযুক্ত / অতীত অভ্যাস", strength: "50%", example: "I would argue that education is key." },
  { modal: "may", bangla: "আনুষ্ঠানিক সম্ভাবনা", strength: "40%", example: "The trend may continue next year." },
  { modal: "might", bangla: "অনিশ্চিত সম্ভাবনা", strength: "30%", example: "This might affect the result." },
  { modal: "need not", bangla: "প্রয়োজন নেই", strength: "—", example: "You needn't worry about minor errors." },
];

const reportedData = [
  { direct: "Simple Present", reported: "Simple Past", directEx: '"I am tired," she said.', reportedEx: "She said she was tired." },
  { direct: "Present Continuous", reported: "Past Continuous", directEx: '"I am studying," he said.', reportedEx: "He said he was studying." },
  { direct: "Present Perfect", reported: "Past Perfect", directEx: '"I have finished," she said.', reportedEx: "She said she had finished." },
  { direct: "Simple Past", reported: "Past Perfect", directEx: '"I went there," he said.', reportedEx: "He said he had gone there." },
  { direct: "will → ", reported: "would", directEx: '"I will help," she said.', reportedEx: "She said she would help." },
  { direct: "can → ", reported: "could", directEx: '"I can do it," he said.', reportedEx: "He said he could do it." },
  { direct: "today → ", reported: "that day", directEx: '"I am busy today."', reportedEx: "She said she was busy that day." },
  { direct: "tomorrow → ", reported: "the next day", directEx: '"I will call tomorrow."', reportedEx: "He said he would call the next day." },
];
...
function FormulaBox({ label, formula }) {
  return (
    <div className="bg-[#0f172a] rounded-xl px-4 py-3 mb-4 border border-white/5">
      ...
      <p className="text-sm font-mono text-[#7dd3fc] leading-relaxed">{formula}</p>
    </div>
  );
}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-4">
        {svaRules.map((r, i) => (
          <div
            ...
            `}
          >
            <p className={`text-[10px] font-bold mb-1 ${active === i ? "text-white/50" : "text-[#d1d5db]"}`}>
              {String(i + 1).padStart(2, "0")}
            </p>
            <p className={`text-xs font-bold leading-snug mb-0.5 ${active === i ? "text-white" : "text-[#111827]"}`}>
              {r.title}
            </p>
            <p className={`text-[10px] leading-snug ${active === i ? "text-white/70" : "text-[#9ca3af]"}`}>
              {r.bangla}
            </p>
          </div>
        ))}
...
function TopicContent({ topic }) {
  ...
  if (c.type === "tense") {
    return (
      <div>
        <p className="text-xs text-[#6b7280] leading-relaxed mb-4">{topic.intro}</p>
        <GrammarTable
        ...
        <TipBox color={tc.tip} label="⚡ IELTS Writing Task 1 Tip">
          Historical graph (past data) → Simple Past | Current/recent trend → Present Perfect | Future projection → Simple Future / will. এই তিনটি tense ঠিকমতো ব্যবহার করলে Grammatical Range &amp; Accuracy-তে ভালো score পাওয়া যায়।
        </TipBox>
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        <TipBox color={tc.tip} label="📝 IELTS Writing Tip">
          Writing Task 1-এ: "The chart shows..." (active) ও "It can be seen that..." (passive) — দুটো মিশিয়ে ব্যবহার করুন। Task 2-তে passive দিয়ে impersonal opinion দেওয়া যায়: "It is argued that..." / "It has been suggested that..."
        </TipBox>
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
          {articlesData.map((a) => (
            <div key={a.article} className="border border-[#e5e7eb] rounded-xl p-3 text-center bg-white">
              <p className="text-2xl font-black text-red-500 mb-1">{a.article}</p>
              <p className="text-[10px] text-[#9ca3af] leading-snug mb-2">{a.bangla}</p>
              <p className="text-[10px] text-[#374151] leading-snug mb-2">{a.use}</p>
              <p className="text-[10px] italic text-[#6b7280] bg-[#f9fafb] rounded-lg px-2 py-1">{a.example}</p>
            </div>
          ))}
        </div>
        <ExamplePair
        ...
        <TipBox color={tc.tip} label="🔑 Key Test — বাংলাভাষীদের জন্য">
          মনে মনে জিজ্ঞেস করুন: কোনটি? নির্দিষ্ট হলে "the", প্রথমবার দেখা অনির্দিষ্ট হলে "a/an", সাধারণ অর্থে হলে কিছু না (Ø)।
        </TipBox>
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        <TipBox color={tc.tip} label="🔑 Key Rule">
          2nd Conditional-এ "If I was" নয়, সবসময় "If I <strong>were</strong>" — এটি formal/written English-এর নিয়ম এবং IELTS Writing ও Speaking-এ গুরুত্বপূর্ণ।
        </TipBox>
      </div>
    );
  }
  ...
  if (c.type === "modals") {
    return (
      <div>
        ...
        />
        <TipBox color={tc.tip} label="📝 IELTS Writing Tip">
          Task 2 opinion paragraph-এ modal ব্যবহার করুন: "I would argue..." (formal) বা "It could be argued..." (impersonal)। এটি examiner-কে sophisticated language দেখায়।
        </TipBox>
      </div>
    );
  }
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-4">
          {[
            ...
            <div key={w.word} className="border border-[#e5e7eb] rounded-xl p-3 text-center bg-white">
              <p className="text-base font-black text-amber-500 mb-1">{w.word}</p>
  ...
  if (c.type === "reported") {
    return (
      <div>
        <p className="text-xs text-[#6b7280] leading-relaxed mb-4">{topic.intro}</p>
        <GrammarTable
          headers={["Direct Speech", "Reported (backshift)", "Direct Example", "Reported Example"]}
        ...
        <TipBox color={tc.tip} label="📢 Reporting Verbs for IELTS">
          said / told / explained / claimed / argued / suggested / admitted / denied / announced — এই verbs দিয়ে reported speech শুরু করুন। "said to" নয়, "told" ব্যবহার করুন।
        </TipBox>
      </div>
    );
  }
...
function TopicSection({ topic }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-xl flex-shrink-0 ${topic.color.icon}`}>
          {topic.emoji}
        </div>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-[#9ca3af] mt-0.5">Tap to expand — formulas, rules, and IELTS tips</p>
        </div>
        <span className={`shrink-0 px-3 py-1 rounded-full text-xs font-bold border ${topic.color.tag}`}>
          {topic.wordCount}
        </span>
        <div
      ...
      {/* Accent bar */}
      <div className={`h-0.5 w-full bg-gradient-to-r ${topic.color.accent} ${open ? "opacity-100" : "opacity-0"} transition-opacity duration-300`} />
      ...
      <div className="w-full bg-[#0f172a] relative overflow-hidden">
        ...
        <div className="relative w-full max-w-[1700px] mx-auto px-6 sm:px-10 lg:px-16 pt-12 pb-0">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <p className="text-white/50 text-base max-w-2xl leading-relaxed">
                Master the grammar structures that appear repeatedly in IELTS Listening, Reading,
                Writing &amp; Speaking — with formulas, tables, and বাংলা tips for every rule.
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-2 pb-6 border-t border-white/10 pt-5">
            <span className="text-white/30 text-xs font-semibold self-center mr-1">Jump to:</span>
            {grammarTopics.map((t) => (
              <a
                key={t.id}
                href={`#${t.id}`}
        ...
        <div className="py-6 flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          ...
          <div className="flex items-center gap-2 bg-white border border-[#e5e7eb] rounded-xl px-4 py-3 shadow-sm shrink-0">
            ...
            <span className="text-sm text-[#374151]">
              ...
              <span className="text-[#9ca3af]"> / {grammarTopics.length} topics</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-[1700px] mx-auto px-6 sm:px-10 lg:px-16 pb-16 space-y-4">
        ...
        {filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-[#374151] font-semibold text-lg mb-1">No topics found</p>
            <p className="text-[#9ca3af] text-sm">Try a different grammar topic name</p>
            <button
              onClick={() => setSearch("")}
